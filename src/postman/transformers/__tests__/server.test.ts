  ...
  describe('host is defined', () => {
    describe('port is defined', () => {
      it('produces server with port', () => {
        expect(transformServer(new Url('https://example.com:666/path'))).toEqual({
          id: expect.any(String),
          url: 'https://example.com:666',
        });
      });
    });
    ...
    describe('port is not defined', () => {
      it('produces server without port', () => {
        expect(transformServer(new Url('https://example.com/path'))).toEqual({
          id: expect.any(String),
